    ...
    * ``create_visualizations`` — generate matplotlib plots and return paths.
    ...
    def generate_full_report(
        ...
        nutrition_section = {
            ...
            "recommended_foods": [
                f.get("name", "") for f in diet.get("recommended_foods", [])[:8]
            ],
...
<div>
  <span class="metric"><span class="value">{tel.get('n_telomeres', 0)}</span><br/><span class="label">Telomeres</span></span>
  <span class="metric"><span class="value">{tel.get('association_rate', 0):.1%}</span><br/><span class="label">Association Rate</span></span>
  <span class="metric"><span class="value">{tel.get('mean_intensity', 0):.1f}</span><br/><span class="label">Mean Intensity</span></span>
  <span class="metric"><span class="value">{tel.get('cv', 0):.2f}</span><br/><span class="label">CV</span></span>
</div>

<h2>Risk Assessment</h2>
<p>Overall risk: <strong>{risk.get('risk_category', 'unknown')}</strong> ({risk.get('overall_risk_score', 0):.0%})</p>
<table>
...
<footer>
  Generated by Teloscopy v1.0 | Report version {html.escape(str(report.get('report_version', '1.0')))}
</footer>
</body>
</html>"""
        return html_doc
    ...
    def create_visualizations(
        ...
        try:
            ...
            if mean_i > 0:
                ...
                bars = ax.bar(labels, values, color=["#3498db", "#2ecc71"], width=0.5)
