...
GEOGRAPHIC_FOOD_DB: list[GeographicProfile] = [
    ...
    GeographicProfile(
        ...
        name="North India",
        common_foods=["roti", "dal", "paneer", "ghee", "lassi", "rajma",
                       "chole", "paratha", "aloo gobi", "basmati rice"],
        staple_grains=["wheat", "basmati rice", "maize", "millet"],
        protein_sources=["paneer", "dal", "rajma", "chicken", "lamb",
                          "chole", "yoghurt", "eggs"],
        vegetables=["potato", "cauliflower", "spinach", "okra", "peas",
                     "tomato", "onion", "bottle gourd", "fenugreek leaves"],
        fruits=["mango", "guava", "papaya", "banana", "apple", "pomegranate"],
        spices=["turmeric", "cumin", "coriander", "garam masala",
                "red chilli", "asafoetida", "fenugreek", "cardamom"],
        traditional_dishes=["dal makhani", "butter chicken", "aloo paratha",
    ...
    GeographicProfile(
        ...
        name="South India",
        common_foods=["idli", "dosa", "sambar", "rasam", "coconut chutney",
                       "appam", "puttu", "avial", "rice", "tamarind rice"],
        staple_grains=["rice", "ragi", "urad dal", "rice flour"],
        protein_sources=["fish", "lentils", "coconut", "eggs", "chicken",
                          "black gram", "prawns", "curd"],
        vegetables=["drumstick", "ash gourd", "snake gourd", "bitter gourd",
                     "banana stem", "curry leaves", "tamarind", "tomato"],
        fruits=["banana", "coconut", "jackfruit", "mango", "sapota",
                "pineapple"],
        spices=["mustard seeds", "curry leaves", "black pepper",
                "tamarind", "coconut", "red chilli", "turmeric", "asafoetida"],
        traditional_dishes=["masala dosa", "idli sambar", "Kerala fish curry",
                             "Hyderabadi biryani", "Chettinad chicken",
                             "rasam", "avial", "payasam"],
    ),
    ...
    GeographicProfile(
        ...
        name="East India",
        common_foods=["rice", "fish curry", "mishti doi", "luchi",
                       "shorshe ilish", "chingri malai curry", "pitha",
                       "dal", "moong dal", "sandesh"],
        staple_grains=["rice", "wheat", "flattened rice"],
        protein_sources=["fish", "prawns", "lentils", "mustard oil",
                          "paneer", "eggs", "chicken", "curd"],
        vegetables=["potato", "brinjal", "pumpkin", "pointed gourd",
                     "banana flower", "green banana", "radish", "spinach"],
        fruits=["mango", "lychee", "jackfruit", "banana", "guava", "palm"],
        spices=["mustard seeds", "panch phoron", "turmeric", "red chilli",
                "ginger", "bay leaf", "radhuni", "nigella seeds"],
        traditional_dishes=["shorshe ilish", "kosha mangsho",
                             "chingri malai curry", "mishti doi",
                             "luchi alur dom", "pitha", "sandesh",
                             "macher jhol"],
    ),
    ...
    GeographicProfile(
        ...
        name="West India",
        common_foods=["dhokla", "thepla", "poha", "vada pav",
                       "pav bhaji", "bhakri", "puran poli", "misal pav",
                       "dal baati", "undhiyu"],
        staple_grains=["wheat", "jowar", "bajra", "rice", "nachni"],
        protein_sources=["lentils", "groundnut", "chickpeas", "fish",
                          "buttermilk", "paneer", "soya", "sprouts"],
        vegetables=["brinjal", "drumstick", "cluster beans", "ivy gourd",
                     "raw banana", "tomato", "onion", "green chilli"],
        fruits=["alphonso mango", "chikoo", "coconut", "banana", "custard apple",
                "pomegranate"],
        spices=["mustard seeds", "sesame", "jaggery", "kokum", "curry leaves",
                "asafoetida", "turmeric", "coriander"],
        traditional_dishes=["dhokla", "vada pav", "pav bhaji", "misal pav",
                             "puran poli", "dal baati churma", "undhiyu",
                             "poha", "shrikhand"],
    ),
    # -- East Asia --------------------------------------------------------
    GeographicProfile(
        region_id="east_asia",
        name="East Asia",
        common_foods=["rice", "noodles", "tofu", "soy sauce", "miso",
                       "kimchi", "bok choy", "dumplings", "congee",
                       "steamed buns"],
        staple_grains=["rice", "wheat noodles", "millet", "buckwheat"],
        protein_sources=["tofu", "fish", "pork", "chicken", "edamame",
                          "eggs", "tempeh", "seaweed", "shrimp"],
        vegetables=["bok choy", "napa cabbage", "daikon", "lotus root",
                     "bamboo shoots", "shiitake mushrooms", "water spinach",
                     "spring onion"],
        fruits=["lychee", "persimmon", "mandarin orange", "Asian pear",
                "dragon fruit", "longan"],
        spices=["soy sauce", "ginger", "garlic", "sesame oil", "star anise",
                "five-spice powder", "Sichuan pepper", "rice vinegar"],
        traditional_dishes=["stir-fried vegetables", "mapo tofu",
                             "sushi", "ramen", "bibimbap", "kung pao chicken",
                             "dumplings", "hot pot"],
    ),
    # -- Southeast Asia ---------------------------------------------------
    GeographicProfile(
        ...
        name="Southeast Asia",
        common_foods=["rice", "noodles", "fish sauce", "coconut milk",
                       "lemongrass", "tofu", "tempeh", "satay",
                       "spring rolls", "pho"],
        staple_grains=["jasmine rice", "sticky rice", "rice noodles",
                        "wheat noodles"],
        protein_sources=["fish", "shrimp", "chicken", "pork", "tofu",
                          "tempeh", "eggs", "duck", "crab"],
        vegetables=["morning glory", "bean sprouts", "Thai basil",
                     "galangal", "kaffir lime leaves", "Thai eggplant",
                     "long beans", "banana blossom"],
        fruits=["durian", "mangosteen", "rambutan", "papaya", "starfruit",
                "pineapple"],
        spices=["lemongrass", "galangal", "fish sauce", "shrimp paste",
                "Thai chilli", "turmeric", "coriander root", "lime leaves"],
        traditional_dishes=["pad thai", "pho", "green curry", "nasi goreng",
                             "tom yum goong", "laksa", "rendang",
                             "banh mi", "satay"],
    ),
    # -- Middle East ------------------------------------------------------
    GeographicProfile(
        ...
        name="Middle East",
        common_foods=["hummus", "falafel", "pita bread", "tabbouleh",
                       "shawarma", "fattoush", "labneh", "halloumi",
                       "dates", "baklava"],
        staple_grains=["wheat", "bulgur", "couscous", "flatbread",
                        "freekeh"],
        protein_sources=["lamb", "chicken", "chickpeas", "lentils",
                          "yoghurt", "halloumi", "fish", "eggs", "fava beans"],
        vegetables=["eggplant", "tomato", "cucumber", "parsley", "mint",
                     "okra", "zucchini", "bell pepper"],
        fruits=["dates", "figs", "pomegranate", "apricot", "grape",
                "orange"],
        spices=["sumac", "za'atar", "cumin", "coriander", "saffron",
                "cardamom", "cinnamon", "allspice"],
        traditional_dishes=["hummus", "falafel", "shawarma", "kibbeh",
                             "mansaf", "moutabal", "fattoush", "tabbouleh",
                             "kunafa"],
    ),
    # -- Mediterranean ----------------------------------------------------
    GeographicProfile(
        ...
        name="Mediterranean",
        common_foods=["olive oil", "bread", "tomato", "feta cheese",
                       "pasta", "grilled fish", "legumes", "wine",
                       "fresh herbs", "yoghurt"],
        staple_grains=["wheat", "barley", "farro", "durum wheat pasta",
                        "sourdough bread"],
        protein_sources=["fish", "chicken", "legumes", "feta",
                          "mozzarella", "eggs", "lamb", "octopus",
                          "sardines"],
        vegetables=["tomato", "eggplant", "zucchini", "artichoke", "olive",
                     "bell pepper", "onion", "garlic", "leafy greens"],
        fruits=["grape", "fig", "lemon", "orange", "peach", "melon"],
        spices=["oregano", "basil", "rosemary", "thyme", "garlic",
                "bay leaf", "saffron", "parsley"],
        traditional_dishes=["Greek salad", "moussaka", "pasta puttanesca",
                             "ratatouille", "paella", "bruschetta",
                             "grilled sea bass", "risotto"],
    ),
    # -- Northern Europe --------------------------------------------------
    GeographicProfile(
        region_id="northern_europe",
        name="Northern Europe",
        common_foods=["rye bread", "potatoes", "herring", "salmon",
                       "berries", "oats", "dairy", "root vegetables",
                       "cabbage", "mushrooms"],
        staple_grains=["rye", "oats", "wheat", "barley"],
        protein_sources=["salmon", "herring", "cod", "pork", "beef",
                          "chicken", "dairy", "eggs", "venison"],
        vegetables=["potato", "cabbage", "beetroot", "turnip", "carrot",
                     "leek", "celery root", "kale", "peas"],
        fruits=["blueberry", "lingonberry", "cloudberry", "apple",
                "pear", "plum"],
        spices=["dill", "caraway", "juniper", "horseradish", "allspice",
                "cardamom", "mustard", "chives"],
        traditional_dishes=["gravlax", "smoked salmon", "meatballs",
                             "rye bread smørrebrød", "fish soup",
                             "potato gratin", "karelian pies",
                             "pickled herring"],
    ),
    # -- Sub-Saharan Africa -----------------------------------------------
    GeographicProfile(
        ...
        common_foods=["fufu", "injera", "ugali", "jollof rice",
                       "plantain", "groundnut soup", "cassava", "yam",
                       "beans", "millet porridge"],
        staple_grains=["teff", "sorghum", "millet", "maize", "rice",
                        "cassava flour"],
        protein_sources=["chicken", "goat", "fish", "beans", "groundnuts",
                          "lentils", "cowpeas", "eggs", "beef"],
        vegetables=["okra", "cassava leaves", "amaranth", "moringa",
                     "sweet potato leaves", "pumpkin", "tomato", "onion"],
        fruits=["mango", "banana", "papaya", "baobab", "passion fruit",
                "guava"],
        spices=["scotch bonnet pepper", "ginger", "garlic", "coriander",
                "berbere", "suya spice", "cumin", "clove"],
        traditional_dishes=["jollof rice", "injera with wot", "fufu and soup",
                             "groundnut soup", "egusi soup", "ugali and sukuma",
                             "bobotie", "nyama choma"],
    ),
    # -- Latin America ----------------------------------------------------
    GeographicProfile(
        ...
        name="Latin America",
        common_foods=["rice and beans", "tortillas", "empanadas",
                       "ceviche", "plantain", "avocado", "salsa",
                       "tamales", "arepas", "quinoa"],
        staple_grains=["maize", "rice", "wheat", "quinoa", "amaranth"],
        protein_sources=["black beans", "chicken", "beef", "pork", "fish",
                          "eggs", "cheese", "lentils", "shrimp"],
        vegetables=["tomato", "bell pepper", "chayote", "nopales",
                     "corn", "avocado", "cassava", "sweet potato"],
        fruits=["mango", "papaya", "guava", "passion fruit", "pineapple",
                "cherimoya"],
        spices=["cumin", "chilli", "cilantro", "oregano", "epazote",
                "achiote", "lime", "garlic"],
        traditional_dishes=["tacos", "ceviche", "feijoada", "empanadas",
                             "arepas", "tamales", "mole poblano",
                             "arroz con pollo", "gallo pinto"],
    ),
    # -- North America ----------------------------------------------------
    GeographicProfile(
        region_id="north_america",
        name="North America",
        common_foods=["bread", "eggs", "chicken breast", "salad",
                       "pasta", "hamburger", "milk", "cheese",
                       "peanut butter", "cereal"],
        staple_grains=["wheat", "corn", "oats", "rice", "barley"],
        protein_sources=["chicken", "beef", "pork", "turkey", "fish",
                          "eggs", "beans", "tofu", "dairy", "nuts"],
        vegetables=["broccoli", "spinach", "kale", "tomato", "bell pepper",
                     "sweet potato", "corn", "green beans", "lettuce"],
        fruits=["apple", "banana", "strawberry", "blueberry", "orange",
                "grape"],
        spices=["black pepper", "garlic powder", "onion powder",
                "paprika", "oregano", "thyme", "cayenne", "cinnamon"],
        traditional_dishes=["grilled chicken salad", "BBQ ribs",
                             "mac and cheese", "clam chowder",
                             "Thanksgiving turkey", "burrito bowl",
                             "Cajun gumbo", "poke bowl"],
    ),
    # -- Central Asia -----------------------------------------------------
    GeographicProfile(
        region_id="central_asia",
        name="Central Asia",
        common_foods=["plov", "naan", "lagman", "kefir", "kurt",
                       "samsa", "shashlik", "beshbarmak", "manti",
                       "kumis"],
        staple_grains=["wheat", "rice", "barley", "millet"],
        protein_sources=["lamb", "beef", "horse meat", "chicken",
                          "yoghurt", "kefir", "lentils", "eggs"],
        vegetables=["carrot", "onion", "potato", "tomato", "pumpkin",
                     "radish", "turnip", "bell pepper"],
        fruits=["melon", "watermelon", "apricot", "grape", "apple",
                "pomegranate"],
        spices=["cumin", "coriander", "black pepper", "barberry",
                "dill", "fennel", "sesame", "garlic"],
        traditional_dishes=["plov", "beshbarmak", "lagman", "manti",
                             "samsa", "shashlik", "kurt", "shorpo"],
    ),
]

# Build a quick-lookup dict by region_id.
_REGION_INDEX: dict[str, GeographicProfile] = {
    gp.region_id: gp for gp in GEOGRAPHIC_FOOD_DB
}
...
NUTRIGENOMICS_DB: list[dict[str, Any]] = [
    ...
    {"rsid": "rs1800562", "gene": "HFE", "nutrient": "iron",
     ...
     "priority": "critical", "daily_target_mg": 8.0,
     "upper_limit_mg": 18.0, "confidence": 0.93},
    # 12 — HFE H63D → iron
    {"rsid": "rs1799945", "gene": "HFE", "nutrient": "iron",
     "effect": "Mildly increased iron absorption",
     "recommendation": "Monitor iron levels; avoid unnecessary supplementation",
     "priority": "moderate", "daily_target_mg": 10.0,
     "upper_limit_mg": 25.0, "confidence": 0.78},
    # 13 — APOE ε4 → saturated fat
    {"rsid": "rs429358", "gene": "APOE", "nutrient": "saturated_fat",
     ...
     "priority": "critical", "daily_target_mg": 0.0,
     "upper_limit_mg": 0.0, "confidence": 0.91},
    # 14 — APOE ε2 → lipid profile
    {"rsid": "rs7412", "gene": "APOE", "nutrient": "saturated_fat",
     "effect": "APOE-ε2 may elevate triglycerides",
     "recommendation": "Moderate total fat; increase omega-3 intake",
     "priority": "moderate", "daily_target_mg": 0.0,
     "upper_limit_mg": 0.0, "confidence": 0.74},
    # 15 — TCF7L2 → glycemic control
    {"rsid": "rs7903146", "gene": "TCF7L2", "nutrient": "glycemic_control",
     ...
     "priority": "critical", "daily_target_mg": 0.0,
     "upper_limit_mg": 0.0, "confidence": 0.90},
    # 16 — TCF7L2 secondary variant
    {"rsid": "rs12255372", "gene": "TCF7L2", "nutrient": "glycemic_control",
    ...
    {"rsid": "rs4680", "gene": "COMT", "nutrient": "polyphenols",
     ...
     "priority": "low", "daily_target_mg": 0.0,
     "upper_limit_mg": 0.0, "confidence": 0.68},
    # 27 — TNF-α → anti-inflammatory diet
    {"rsid": "rs1800629", "gene": "TNF", "nutrient": "anti_inflammatory",
     ...
     "priority": "high", "daily_target_mg": 0.0,
     "upper_limit_mg": 0.0, "confidence": 0.80},
    # 28 — IL6 → anti-inflammatory
    {"rsid": "rs1800795", "gene": "IL6", "nutrient": "anti_inflammatory",
     ...
     "priority": "moderate", "daily_target_mg": 0.0,
     "upper_limit_mg": 0.0, "confidence": 0.73},
    # 29 — SOD2 → antioxidants
    {"rsid": "rs4880", "gene": "SOD2", "nutrient": "antioxidants",
...
_ALL = [
    "south_asia_north", "south_asia_south", "south_asia_east",
    "south_asia_west", "east_asia", "southeast_asia", "middle_east",
    "mediterranean", "northern_europe", "sub_saharan_africa",
    "latin_america", "north_america", "central_asia",
]

FOOD_DATABASE: list[FoodItem] = [
    # ======================== GRAINS & CEREALS ==========================
    _fi("brown rice", 112, 2.6, 23.5, 0.9, 1.8,
        {"magnesium": 43.0, "selenium": 9.8, "manganese": 0.9},
        "grain", _ALL),
    _fi("white rice", 130, 2.7, 28.2, 0.3, 0.4,
        {"iron": 0.2, "thiamine": 0.02},
        "grain", _ALL),
    _fi("basmati rice", 121, 3.5, 25.2, 0.4, 0.4,
        {"iron": 0.5, "thiamine": 0.07},
        "grain", ["south_asia_north", "south_asia_south", "middle_east"]),
    _fi("whole wheat roti", 297, 9.8, 50.0, 6.5, 11.0,
        {"iron": 3.5, "folate": 0.04, "magnesium": 117.0},
        "grain", ["south_asia_north", "south_asia_west", "south_asia_east"]),
    _fi("quinoa", 120, 4.4, 21.3, 1.9, 2.8,
        {"iron": 1.5, "magnesium": 64.0, "manganese": 0.6, "folate": 0.042},
        "grain", ["latin_america", "north_america", "mediterranean"]),
    _fi("oats", 389, 16.9, 66.3, 6.9, 10.6,
        {"iron": 4.7, "magnesium": 177.0, "zinc": 3.97, "thiamine": 0.76},
        "grain", ["northern_europe", "north_america"]),
    _fi("rye bread", 259, 8.5, 48.3, 3.3, 5.8,
        {"iron": 2.8, "selenium": 30.9, "folate": 0.11},
        "grain", ["northern_europe"]),
    _fi("millet", 378, 11.0, 72.8, 4.2, 8.5,
        {"iron": 3.0, "magnesium": 114.0, "phosphorus": 285.0},
        "grain", ["sub_saharan_africa", "south_asia_north", "central_asia"]),
    _fi("teff", 367, 13.3, 73.1, 2.4, 8.0,
        {"iron": 7.6, "calcium": 180.0, "magnesium": 184.0},
        "grain", ["sub_saharan_africa"]),
    _fi("corn tortilla", 218, 5.7, 44.6, 2.8, 5.3,
        {"calcium": 46.0, "iron": 1.5, "niacin": 1.5},
        "grain", ["latin_america", "north_america"]),
    _fi("bulgur wheat", 342, 12.3, 75.9, 1.3, 12.5,
        {"iron": 2.5, "magnesium": 164.0, "manganese": 3.0},
        "grain", ["middle_east", "mediterranean"]),
    _fi("sorghum", 329, 10.6, 72.1, 3.5, 6.7,
        {"iron": 3.4, "phosphorus": 289.0, "potassium": 363.0},
        "grain", ["sub_saharan_africa", "south_asia_west"]),
    _fi("buckwheat", 343, 13.3, 71.5, 3.4, 10.0,
        {"magnesium": 231.0, "manganese": 1.3, "copper": 1.1},
        "grain", ["east_asia", "northern_europe", "central_asia"]),

    # ======================== LEGUMES ===================================
    _fi("red lentils", 116, 9.0, 20.1, 0.4, 3.8,
        {"iron": 3.3, "folate": 0.181, "potassium": 369.0, "zinc": 1.3},
        "legume", _ALL),
    _fi("chickpeas", 164, 8.9, 27.4, 2.6, 7.6,
        {"iron": 2.9, "folate": 0.172, "magnesium": 48.0, "zinc": 1.5},
        "legume", ["south_asia_north", "middle_east", "mediterranean"]),
    _fi("black beans", 132, 8.9, 23.7, 0.5, 8.7,
        {"iron": 2.1, "folate": 0.149, "magnesium": 70.0, "potassium": 355.0},
        "legume", ["latin_america", "north_america"]),
    _fi("kidney beans (rajma)", 127, 8.7, 22.8, 0.5, 6.4,
        {"iron": 2.9, "folate": 0.130, "potassium": 403.0},
        "legume", ["south_asia_north", "latin_america"]),
    _fi("edamame", 121, 11.9, 8.9, 5.2, 5.2,
        {"iron": 2.3, "folate": 0.311, "vitamin_c": 6.1, "calcium": 63.0},
        "legume", ["east_asia", "southeast_asia", "north_america"]),
    _fi("cowpeas", 116, 7.7, 20.8, 0.5, 6.5,
        {"iron": 2.5, "folate": 0.208, "potassium": 278.0},
        "legume", ["sub_saharan_africa", "south_asia_south"]),
    _fi("mung beans", 105, 7.0, 19.1, 0.4, 7.6,
        {"iron": 1.4, "folate": 0.159, "magnesium": 48.0},
        "legume", ["south_asia_south", "east_asia", "southeast_asia"]),
    _fi("fava beans", 110, 7.6, 19.7, 0.4, 5.4,
        {"iron": 1.5, "folate": 0.148, "manganese": 0.4},
        "legume", ["middle_east", "mediterranean"]),

    # ======================== VEGETABLES ================================
    _fi("spinach", 23, 2.9, 3.6, 0.4, 2.2,
        {"iron": 2.7, "folate": 0.194, "vitamin_c": 28.1, "vitamin_a": 0.469,
         "calcium": 99.0, "magnesium": 79.0},
        "vegetable", _ALL),
    _fi("broccoli", 34, 2.8, 6.6, 0.4, 2.6,
        {"vitamin_c": 89.2, "folate": 0.063, "vitamin_a": 0.031,
         "calcium": 47.0, "sulforaphane": 1.0},
        "vegetable", _ALL),
    _fi("kale", 49, 4.3, 8.8, 0.9, 3.6,
        {"vitamin_c": 120.0, "vitamin_a": 0.500, "calcium": 150.0,
         "iron": 1.5, "folate": 0.141},
        "vegetable", ["northern_europe", "north_america", "mediterranean"]),
    _fi("sweet potato", 86, 1.6, 20.1, 0.1, 3.0,
        {"vitamin_a": 0.709, "vitamin_c": 2.4, "potassium": 337.0,
         "manganese": 0.3},
        "vegetable", _ALL),
    _fi("tomato", 18, 0.9, 3.9, 0.2, 1.2,
        {"vitamin_c": 13.7, "lycopene": 2.6, "potassium": 237.0,
         "folate": 0.015},
        "vegetable", _ALL),
    _fi("okra", 33, 1.9, 7.5, 0.2, 3.2,
        {"vitamin_c": 23.0, "folate": 0.060, "magnesium": 57.0,
         "calcium": 82.0},
        "vegetable", ["south_asia_north", "south_asia_south",
                       "sub_saharan_africa", "middle_east"]),
    _fi("bitter gourd", 17, 1.0, 3.7, 0.2, 2.8,
        {"vitamin_c": 84.0, "folate": 0.072, "iron": 0.4, "zinc": 0.8},
        "vegetable", ["south_asia_south", "southeast_asia", "east_asia"]),
    _fi("moringa leaves", 64, 9.4, 8.3, 1.4, 2.0,
        {"vitamin_a": 0.378, "vitamin_c": 51.7, "calcium": 185.0,
         "iron": 4.0, "potassium": 337.0},
        "vegetable", ["sub_saharan_africa", "south_asia_south",
                       "southeast_asia"]),
    _fi("bok choy", 13, 1.5, 2.2, 0.2, 1.0,
        {"vitamin_c": 45.0, "vitamin_a": 0.223, "calcium": 105.0,
         "folate": 0.066},
        "vegetable", ["east_asia", "southeast_asia"]),
    _fi("eggplant", 25, 1.0, 5.9, 0.2, 3.0,
        {"potassium": 229.0, "manganese": 0.2, "folate": 0.022},
        "vegetable", ["mediterranean", "middle_east", "south_asia_south"]),
    _fi("Brussels sprouts", 43, 3.4, 8.9, 0.3, 3.8,
        {"vitamin_c": 85.0, "vitamin_a": 0.038, "folate": 0.061,
         "sulforaphane": 0.8},
        "vegetable", ["northern_europe", "north_america"]),
    _fi("cauliflower", 25, 1.9, 5.0, 0.3, 2.0,
        {"vitamin_c": 48.2, "folate": 0.057, "vitamin_b6": 0.18},
        "vegetable", _ALL),
    _fi("carrot", 41, 0.9, 9.6, 0.2, 2.8,
        {"vitamin_a": 0.835, "potassium": 320.0, "biotin": 0.006},
        "vegetable", _ALL),
    _fi("drumstick (moringa pods)", 37, 2.1, 8.5, 0.2, 3.2,
        {"vitamin_c": 141.0, "calcium": 30.0, "iron": 0.4},
        "vegetable", ["south_asia_south", "sub_saharan_africa"]),
    _fi("nopales (cactus pads)", 16, 1.3, 3.3, 0.1, 2.2,
        {"vitamin_c": 9.3, "calcium": 164.0, "magnesium": 52.0},
        "vegetable", ["latin_america"]),

    # ======================== FRUITS ====================================
    _fi("banana", 89, 1.1, 22.8, 0.3, 2.6,
        {"potassium": 358.0, "vitamin_b6": 0.37, "vitamin_c": 8.7,
         "magnesium": 27.0},
        "fruit", _ALL),
    _fi("mango", 60, 0.8, 15.0, 0.4, 1.6,
        {"vitamin_c": 36.4, "vitamin_a": 0.054, "folate": 0.043},
        "fruit", ["south_asia_north", "south_asia_south", "southeast_asia",
                   "sub_saharan_africa", "latin_america"]),
    _fi("blueberry", 57, 0.7, 14.5, 0.3, 2.4,
        {"vitamin_c": 9.7, "vitamin_k": 0.019, "manganese": 0.3,
         "anthocyanins": 25.0},
        "fruit", ["northern_europe", "north_america"]),
    _fi("guava", 68, 2.6, 14.3, 1.0, 5.4,
        {"vitamin_c": 228.3, "folate": 0.049, "potassium": 417.0,
         "vitamin_a": 0.031},
        "fruit", ["south_asia_north", "latin_america", "southeast_asia",
                   "sub_saharan_africa"]),
    _fi("papaya", 43, 0.5, 10.8, 0.3, 1.7,
        {"vitamin_c": 60.9, "vitamin_a": 0.047, "folate": 0.037,
         "potassium": 182.0},
        "fruit", ["southeast_asia", "latin_america", "sub_saharan_africa"]),
    _fi("orange", 47, 0.9, 11.8, 0.1, 2.4,
        {"vitamin_c": 53.2, "folate": 0.030, "potassium": 181.0,
         "thiamine": 0.09},
        "fruit", _ALL),
    _fi("pomegranate", 83, 1.7, 18.7, 1.2, 4.0,
        {"vitamin_c": 10.2, "vitamin_k": 0.016, "folate": 0.038,
         "potassium": 236.0, "punicalagins": 50.0},
        "fruit", ["south_asia_north", "middle_east", "mediterranean"]),
    _fi("dates", 277, 1.8, 75.0, 0.2, 6.7,
        {"potassium": 696.0, "magnesium": 54.0, "iron": 0.9,
         "vitamin_b6": 0.25},
        "fruit", ["middle_east", "sub_saharan_africa"]),
    _fi("jackfruit", 95, 1.7, 23.3, 0.6, 1.5,
        {"vitamin_c": 13.7, "potassium": 448.0, "magnesium": 29.0},
        "fruit", ["south_asia_south", "southeast_asia"]),
    _fi("avocado", 160, 2.0, 8.5, 14.7, 6.7,
        {"potassium": 485.0, "folate": 0.081, "vitamin_k": 0.021,
         "vitamin_e": 2.1, "magnesium": 29.0},
        "fruit", ["latin_america", "north_america", "mediterranean"]),
    _fi("apple", 52, 0.3, 13.8, 0.2, 2.4,
        {"vitamin_c": 4.6, "potassium": 107.0, "quercetin": 4.0},
        "fruit", ["northern_europe", "north_america", "central_asia"]),
    _fi("fig", 74, 0.8, 19.2, 0.3, 2.9,
        {"calcium": 35.0, "potassium": 232.0, "iron": 0.4,
         "magnesium": 17.0},
        "fruit", ["mediterranean", "middle_east"]),
    _fi("baobab fruit powder", 250, 2.3, 58.0, 0.3, 44.5,
        {"vitamin_c": 280.0, "calcium": 293.0, "iron": 9.3,
         "potassium": 2270.0},
        "fruit", ["sub_saharan_africa"]),

    # ======================== PROTEIN SOURCES ===========================
    _fi("chicken breast", 165, 31.0, 0.0, 3.6, 0.0,
        {"selenium": 27.6, "niacin": 13.7, "vitamin_b6": 0.6,
         "phosphorus": 228.0},
        "poultry", _ALL),
    _fi("salmon", 208, 20.4, 0.0, 13.4, 0.0,
        {"omega_3": 2260.0, "selenium": 36.5, "vitamin_d_iu": 526.0,
         "vitamin_b12": 0.003},
        "fish", ["northern_europe", "north_america", "east_asia"]),
    _fi("sardines", 208, 24.6, 0.0, 11.5, 0.0,
        {"omega_3": 1480.0, "calcium": 382.0, "vitamin_d_iu": 272.0,
         "vitamin_b12": 0.009, "selenium": 52.7},
        "fish", ["mediterranean", "northern_europe", "southeast_asia"]),
    _fi("mackerel", 205, 18.6, 0.0, 13.9, 0.0,
        {"omega_3": 2670.0, "vitamin_d_iu": 643.0, "selenium": 44.1,
         "vitamin_b12": 0.019},
        "fish", ["east_asia", "northern_europe", "southeast_asia"]),
    _fi("eggs", 155, 13.0, 1.1, 11.0, 0.0,
        {"selenium": 30.7, "vitamin_d_iu": 82.0, "vitamin_b12": 0.001,
         "choline": 293.8, "vitamin_a": 0.160},
        "eggs", _ALL),
    _fi("tofu (firm)", 76, 8.2, 1.9, 4.8, 0.3,
        {"calcium": 350.0, "iron": 5.4, "magnesium": 30.0,
         "selenium": 17.4},
        "legume", ["east_asia", "southeast_asia", "north_america"]),
    _fi("paneer", 265, 18.3, 1.2, 20.8, 0.0,
        {"calcium": 480.0, "phosphorus": 138.0, "selenium": 17.0},
        "dairy", ["south_asia_north", "south_asia_west"]),
    _fi("Greek yoghurt", 59, 10.2, 3.6, 0.7, 0.0,
        {"calcium": 110.0, "vitamin_b12": 0.001, "potassium": 141.0,
         "probiotics": 1.0},
        "dairy", _ALL),
    _fi("lamb", 294, 25.5, 0.0, 20.9, 0.0,
        {"iron": 1.9, "zinc": 4.7, "vitamin_b12": 0.003, "selenium": 26.4},
        "meat", ["middle_east", "south_asia_north", "mediterranean",
                  "central_asia"]),
    _fi("goat meat", 143, 27.1, 0.0, 3.0, 0.0,
        {"iron": 3.7, "zinc": 5.3, "vitamin_b12": 0.001, "selenium": 8.8},
        "meat", ["sub_saharan_africa", "south_asia_north", "middle_east",
                  "central_asia"]),
    _fi("tempeh", 192, 20.3, 7.6, 10.8, 0.0,
        {"calcium": 111.0, "iron": 2.7, "magnesium": 81.0, "manganese": 1.3},
        "legume", ["southeast_asia", "east_asia"]),
    _fi("lentil dal", 116, 9.0, 20.0, 0.4, 3.8,
        {"iron": 3.3, "folate": 0.181, "potassium": 369.0},
        "legume", ["south_asia_north", "south_asia_south", "south_asia_east",
                     "south_asia_west"]),
    _fi("shrimp", 99, 24.0, 0.2, 0.3, 0.0,
        {"selenium": 38.0, "vitamin_b12": 0.001, "iodine": 0.035,
         "zinc": 1.6},
        "fish", ["southeast_asia", "east_asia", "mediterranean",
                  "latin_america"]),

    # ======================== NUTS & SEEDS ==============================
    _fi("almonds", 579, 21.2, 21.6, 49.9, 12.5,
        {"vitamin_e": 25.6, "magnesium": 270.0, "calcium": 269.0,
         "iron": 3.7},
        "nut", _ALL),
    _fi("walnuts", 654, 15.2, 13.7, 65.2, 6.7,
        {"omega_3": 9080.0, "magnesium": 158.0, "manganese": 3.4,
         "copper": 1.6},
        "nut", _ALL),
    _fi("flaxseed", 534, 18.3, 28.9, 42.2, 27.3,
        {"omega_3": 22800.0, "magnesium": 392.0, "manganese": 2.5,
         "thiamine": 1.64},
        "seed", _ALL),
    _fi("chia seeds", 486, 16.5, 42.1, 30.7, 34.4,
        {"omega_3": 17552.0, "calcium": 631.0, "magnesium": 335.0,
         "iron": 7.7},
        "seed", ["latin_america", "north_america"]),
    _fi("pumpkin seeds", 559, 30.2, 10.7, 49.1, 6.0,
        {"zinc": 7.8, "magnesium": 550.0, "iron": 8.8, "manganese": 4.5},
        "seed", _ALL),
    _fi("groundnuts (peanuts)", 567, 25.8, 16.1, 49.2, 8.5,
        {"niacin": 12.1, "folate": 0.240, "magnesium": 168.0,
         "vitamin_e": 8.3},
        "nut", ["sub_saharan_africa", "south_asia_north", "southeast_asia",
                 "north_america"]),
    _fi("sunflower seeds", 584, 20.8, 20.0, 51.5, 8.6,
        {"vitamin_e": 35.2, "selenium": 53.0, "magnesium": 325.0},
        "seed", _ALL),
    _fi("sesame seeds", 573, 17.7, 23.4, 49.7, 11.8,
        {"calcium": 975.0, "iron": 14.6, "magnesium": 351.0, "zinc": 7.8},
        "seed", ["middle_east", "east_asia", "south_asia_north"]),
    _fi("cashews", 553, 18.2, 30.2, 43.9, 3.3,
        {"magnesium": 292.0, "zinc": 5.8, "iron": 6.7, "copper": 2.2},
        "nut", ["south_asia_west", "southeast_asia", "sub_saharan_africa"]),

    # ======================== DAIRY & ALTERNATIVES =======================
    _fi("whole milk", 61, 3.2, 4.8, 3.3, 0.0,
        {"calcium": 113.0, "vitamin_d_iu": 40.0, "vitamin_b12": 0.0004,
         "phosphorus": 84.0},
        "dairy", _ALL),
    _fi("kefir", 63, 3.3, 4.5, 3.5, 0.0,
        {"calcium": 130.0, "vitamin_b12": 0.0003, "probiotics": 1.0},
        "dairy", ["northern_europe", "central_asia", "middle_east"]),
    _fi("labneh", 163, 8.0, 4.0, 13.0, 0.0,
        {"calcium": 180.0, "vitamin_b12": 0.0004, "probiotics": 1.0},
        "dairy", ["middle_east", "mediterranean"]),
    _fi("feta cheese", 264, 14.2, 4.1, 21.3, 0.0,
        {"calcium": 493.0, "phosphorus": 337.0, "vitamin_b12": 0.002,
         "sodium": 1116.0},
        "dairy", ["mediterranean", "middle_east"]),

    # ======================== OILS & FATS ================================
    _fi("olive oil", 884, 0.0, 0.0, 100.0, 0.0,
        {"vitamin_e": 14.4, "vitamin_k": 0.060, "oleic_acid": 73000.0,
         "polyphenols": 200.0},
        "oil", ["mediterranean", "middle_east"]),
    _fi("coconut oil", 862, 0.0, 0.0, 100.0, 0.0,
        {"lauric_acid": 44600.0, "vitamin_e": 0.1},
        "oil", ["south_asia_south", "southeast_asia"]),
    _fi("ghee", 900, 0.0, 0.0, 100.0, 0.0,
        {"vitamin_a": 0.684, "vitamin_d_iu": 20.0, "vitamin_e": 2.8,
         "butyrate": 3000.0},
        "oil", ["south_asia_north", "south_asia_west", "south_asia_east"]),
    _fi("mustard oil", 884, 0.0, 0.0, 100.0, 0.0,
        {"omega_3": 5900.0, "vitamin_e": 11.6, "erucic_acid": 42000.0},
        "oil", ["south_asia_north", "south_asia_east"]),

    # ======================== SPICES / FUNCTIONAL FOODS ==================
    _fi("turmeric powder", 354, 7.8, 64.9, 9.9, 21.1,
        {"curcumin": 3140.0, "iron": 41.4, "manganese": 7.8,
         "potassium": 2525.0},
        "spice", _ALL),
    _fi("ginger root", 80, 1.8, 17.8, 0.8, 2.0,
        {"gingerol": 300.0, "potassium": 415.0, "magnesium": 43.0,
         "vitamin_c": 5.0},
        "spice", _ALL),
    _fi("garlic", 149, 6.4, 33.1, 0.5, 2.1,
        {"allicin": 4500.0, "selenium": 14.2, "vitamin_c": 31.2,
         "manganese": 1.7},
        "spice", _ALL),
    _fi("cinnamon", 247, 4.0, 80.6, 1.2, 53.1,
        {"calcium": 1002.0, "iron": 8.3, "manganese": 17.5},
        "spice", _ALL),
    _fi("green tea (brewed)", 1, 0.2, 0.0, 0.0, 0.0,
        {"catechins": 80.0, "theanine": 20.0, "caffeine": 25.0,
         "vitamin_c": 0.3},
        "beverage", ["east_asia", "southeast_asia", "north_america"]),
    _fi("dark chocolate (70%)", 598, 7.8, 45.9, 42.6, 10.9,
        {"iron": 11.9, "magnesium": 228.0, "copper": 1.8, "manganese": 2.0,
         "flavonoids": 500.0},
        "snack", _ALL),

    # ======================== PREPARED / MIXED FOODS ====================
    _fi("hummus", 166, 7.9, 14.3, 9.6, 6.0,
        {"iron": 2.4, "folate": 0.083, "vitamin_b6": 0.2, "zinc": 1.8},
        "prepared", ["middle_east", "mediterranean", "north_america"]),
    _fi("idli", 77, 2.0, 15.0, 0.4, 0.5,
        {"iron": 0.9, "calcium": 14.0, "folate": 0.010},
        "prepared", ["south_asia_south"]),
    _fi("miso", 199, 11.7, 26.5, 6.0, 5.4,
        {"sodium": 3728.0, "zinc": 2.6, "manganese": 0.9, "vitamin_k": 0.029},
        "prepared", ["east_asia"]),
    _fi("kimchi", 15, 1.1, 2.4, 0.5, 1.6,
        {"vitamin_c": 18.0, "vitamin_a": 0.018, "probiotics": 1.0,
         "sodium": 498.0},
        "prepared", ["east_asia"]),
    _fi("injera (teff)", 135, 3.9, 28.0, 0.6, 1.6,
        {"iron": 3.5, "calcium": 80.0, "probiotics": 1.0},
        "prepared", ["sub_saharan_africa"]),
    _fi("cassava (boiled)", 160, 1.4, 38.1, 0.3, 1.8,
        {"vitamin_c": 20.6, "potassium": 271.0, "manganese": 0.4},
        "prepared", ["sub_saharan_africa", "latin_america",
                      "southeast_asia"]),
    _fi("plantain (cooked)", 116, 0.8, 31.2, 0.4, 2.3,
        {"vitamin_c": 18.4, "potassium": 465.0, "vitamin_a": 0.056,
         "magnesium": 37.0},
        "prepared", ["sub_saharan_africa", "latin_america"]),
    _fi("pho (broth base)", 25, 2.0, 2.5, 0.8, 0.0,
        {"sodium": 380.0, "collagen": 500.0},
        "prepared", ["southeast_asia"]),

    # ======================== ADDITIONAL TO REACH 100+ ===================
    _fi("cod (Atlantic)", 82, 17.8, 0.0, 0.7, 0.0,
        {"selenium": 33.1, "vitamin_b12": 0.001, "iodine": 0.170,
         "phosphorus": 203.0},
        "fish", ["northern_europe", "north_america"]),
    _fi("herring", 158, 18.0, 0.0, 9.0, 0.0,
        {"omega_3": 1729.0, "vitamin_d_iu": 680.0, "selenium": 36.5},
        "fish", ["northern_europe"]),
    _fi("beef (lean)", 250, 26.1, 0.0, 15.0, 0.0,
        {"iron": 2.6, "zinc": 6.3, "vitamin_b12": 0.003, "selenium": 18.0},
        "meat", _ALL),
    _fi("turkey breast", 135, 30.0, 0.0, 1.0, 0.0,
        {"selenium": 32.1, "niacin": 11.8, "vitamin_b6": 0.8},
        "poultry", ["north_america", "northern_europe"]),
    _fi("lychee", 66, 0.8, 16.5, 0.4, 1.3,
        {"vitamin_c": 71.5, "potassium": 171.0, "copper": 0.1},
        "fruit", ["east_asia", "south_asia_east", "southeast_asia"]),
    _fi("persimmon", 70, 0.6, 18.6, 0.2, 3.6,
        {"vitamin_a": 0.081, "vitamin_c": 7.5, "manganese": 0.4},
        "fruit", ["east_asia", "mediterranean"]),
    _fi("dragon fruit", 60, 1.2, 13.0, 0.4, 1.8,
        {"vitamin_c": 3.0, "iron": 0.7, "magnesium": 40.0},
        "fruit", ["southeast_asia", "latin_america"]),
    _fi("passion fruit", 97, 2.2, 23.4, 0.7, 10.4,
        {"vitamin_c": 30.0, "vitamin_a": 0.064, "iron": 1.6,
         "potassium": 348.0},
        "fruit", ["latin_america", "sub_saharan_africa", "southeast_asia"]),
    _fi("seaweed (nori)", 35, 5.8, 5.1, 0.3, 0.3,
        {"iodine": 1.5, "iron": 1.8, "vitamin_b12": 0.0003,
         "calcium": 70.0},
        "vegetable", ["east_asia"]),
    _fi("lotus root", 74, 2.6, 17.2, 0.1, 4.9,
        {"vitamin_c": 44.0, "potassium": 556.0, "manganese": 0.3},
        "vegetable", ["east_asia", "southeast_asia"]),
    _fi("coconut milk", 230, 2.3, 6.0, 23.8, 0.0,
        {"manganese": 0.9, "iron": 1.6, "magnesium": 37.0},
        "dairy", ["south_asia_south", "southeast_asia"]),
]

# Quick count assertion.
assert len(FOOD_DATABASE) >= 100, (
    f"Food DB has only {len(FOOD_DATABASE)} entries; expected ≥ 100."
)

# Index foods by name (lower-case) for quick lookup.
_FOOD_NAME_INDEX: dict[str, FoodItem] = {
    fi.name.lower(): fi for fi in FOOD_DATABASE
}
...
_NUTRIENT_MICRO_KEYS: dict[str, list[str]] = {
    ...
    "magnesium": ["magnesium"],
    "selenium": ["selenium"],
    "antioxidants": ["vitamin_c", "vitamin_e", "selenium", "flavonoids",
                     "anthocyanins", "polyphenols"],
    "polyphenols": ["polyphenols", "catechins", "flavonoids",
                    "anthocyanins", "punicalagins"],
    "anti_inflammatory": ["omega_3", "curcumin", "gingerol",
                          "anthocyanins", "polyphenols"],
...
_GLUTEN_KEYWORDS: set[str] = {
    "wheat", "roti", "bread", "pasta", "rye", "bulgur",
    "couscous", "naan", "pita", "tortilla", "barley", "seitan",
}

_HALAL_EXCLUDED: set[str] = {"pork", "ham", "bacon", "wine", "beer", "lard"}
_KOSHER_EXCLUDED: set[str] = {"pork", "ham", "bacon", "shellfish", "shrimp",
                               "crab", "lobster", "lard"}
...
_TELOMERE_PROTECTIVE_NUTRIENTS: list[dict[str, Any]] = [
    {"nutrient": "omega_3", "effect": "Reduces oxidative telomere shortening",
     "priority": "critical", "confidence": 0.88},
    {"nutrient": "folate", "effect": "Supports DNA methylation and repair",
     "priority": "high", "confidence": 0.82},
    {"nutrient": "vitamin_d", "effect": "Modulates telomerase activity",
     "priority": "high", "confidence": 0.78},
    {"nutrient": "vitamin_c", "effect": "Antioxidant protection of telomeric DNA",
     "priority": "moderate", "confidence": 0.75},
    {"nutrient": "vitamin_e",
     "effect": "Lipid peroxidation protection near telomeres",
     "priority": "moderate", "confidence": 0.72},
    {"nutrient": "polyphenols",
     "effect": "Upregulate telomerase via NF-κB pathway modulation",
     "priority": "moderate", "confidence": 0.70},
    {"nutrient": "zinc", "effect": "Required co-factor for telomerase",
     "priority": "moderate", "confidence": 0.73},
    {"nutrient": "magnesium",
     "effect": "DNA stability and repair enzyme cofactor",
     "priority": "moderate", "confidence": 0.68},
...
class DietAdvisor:
    ...
    def __init__(
        ...
        self._nutri_db: list[dict[str, Any]] = (
            nutrigenomics_db or list(NUTRIGENOMICS_DB)
        )
    ...
    def calculate_nutrient_needs(
        ...
        for rsid, genotype in variants.items():
            ...
            for entry in entries:
                ...
                adjusted_target = self._adjust_target(
                    base_target, dosage, age, sex, nutrient
                )
                ...
                if existing is None or _PRIORITY_RANK.get(
                    need.priority, 0
        ...
        needs.sort(
            key=lambda n: _PRIORITY_RANK.get(n.priority, 0), reverse=True
        )
        return needs
    ...
    def generate_recommendations(
        ...
        for rn in risk_nutrients:
            if rn["nutrient"] not in combined:
                ...
                if _PRIORITY_RANK.get(
                    rn.get("priority", "low"), 0
                ) > _PRIORITY_RANK.get(existing.get("priority", "low"), 0):
                    existing["priority"] = rn["priority"]

        recommendations: list[DietaryRecommendation] = []
        for nutrient, info in combined.items():
            target_foods = self._find_target_foods(
                nutrient, region, restrictions
            )
            avoid_foods = self._find_avoid_foods(nutrient, genetic_risks)
            daily_str = self._format_daily_target(
                nutrient, info.get("daily_target", 0.0)
            )
        ...
        recommendations.sort(
            key=lambda r: _PRIORITY_RANK.get(r.priority, 0), reverse=True
        )
    ...
    def create_meal_plan(
        ...
        breakfast_candidates = [
            ...
            if fi.food_group in ("grain", "fruit", "dairy", "eggs",
                                 "nut", "seed", "prepared", "beverage")
        ]
        main_candidates = [
            fi for fi in scored
            if fi.food_group in ("grain", "legume", "vegetable", "fish",
                                 "meat", "poultry", "prepared", "oil")
        ]
        snack_candidates = [
            fi for fi in scored
            if fi.food_group in ("fruit", "nut", "seed", "snack",
                                 "dairy", "beverage")
        ]
    ...
    def get_region_specific_foods(
        ...
        def nutrient_score(fi: FoodItem) -> float:
            return sum(
                fi.key_micronutrients.get(k, 0.0) for k in micro_keys
            )
    ...
    def get_telomere_protective_diet(
        ...
        sex = str(telomere_data.get("sex", "female")).lower()
        ...
        for entry in _TELOMERE_PROTECTIVE_NUTRIENTS:
            ...
            rec = DietaryRecommendation(
                ...
                daily_target=self._telomere_daily_target(
                    nutrient, urgency_mult
                ),
    ...
    def adapt_to_restrictions(
        ...
        for day_plan in meal_plan:
            new_plan = MealPlan(
                day=day_plan.day,
                breakfast=self._filter_meal(
                    day_plan.breakfast, restrictions
                ),
            ...
            new_plan.notes.append(
                f"Adapted for: {', '.join(restrictions)}"
            )
    ...
    def _find_avoid_foods(
        ...
        if nutrient == "saturated_fat" or "Coronary artery disease" in genetic_risks:
            avoid.extend(["processed meat", "deep-fried foods", "butter",
                          "palm oil", "margarine"])
        if nutrient == "glycemic_control" or "Type 2 diabetes" in genetic_risks:
            avoid.extend(["white bread", "sugary drinks", "candy",
                          "white rice (excess)", "pastries"])
        if nutrient == "lactose":
            avoid.extend(["whole milk", "ice cream", "soft cheese"])
        if nutrient == "caffeine":
            avoid.extend(["energy drinks", "excessive coffee",
    ...
    def _build_recommendation_text(
        ...
        gene = info.get("gene", "")
        parts = [
            f"Based on {'your ' + gene + ' variant' if gene else 'risk profile'}: "
            f"{base}.",
            f"Focus on {nutrient.replace('_', ' ')}-rich foods available in "
            f"{region_name}.",
        ]
    ...
    def _score_foods(
        ...
        for nut in target_nutrients:
            micro_keys_flat.update(
                _NUTRIENT_MICRO_KEYS.get(nut, [nut])
            )
